...
res = new_MIPTAutocorr.brickwork_circuit_dynamics(L, T_meas, pmeas_ar, deepcopy(state_i), is_pbc; extract_gates=false, unitaries_type=unitaries_type, measure_I5=measure_I5, measure_I3=measure_I3)
